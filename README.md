...
* **ex1_simple_ZARC_model.ipynb**: one ZARC element consisting of a resistance placed in parallel to a constant phase element (CPE), the freqeuncy range is from $10^{-4}$ Hz to $10^4$ Hz with 10 points per decade (ppd).
